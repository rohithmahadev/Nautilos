...
if uploaded_pdf_file is not None:
    ...
    st.session_state.pdf_data  = loader.load()
...
prompt_extract = PromptTemplate.from_template(
 ...
 {page_data}
 ### Instruction:
 The scrapted text is from the career's page of a company's website. The instruction for you is to extract the job posting, skills, experience and salary and return them in JSON format containing the 
 follwing keys:
